...
7. **Hold Equipment Lightly.** Buy what you will use until it breaks, and resist the marketing cycle that wants a new bag every three years. Persimmon, hickory, and graphite all belong in the hands of a Member who knows why they chose.
...
1. **Visitors' Rule.** Any guest introduced by a Member plays at a green fee of one dram, payable to the flask of the host.
2. **Cheap to Join, Hard to Win.** The Club keeps no waiting list and charges no initiation. The only gate is the bogey competition and the only currency is honor (and the occasional dram): a bogey club should be cheap to join and hard to win.
